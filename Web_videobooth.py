...
# Route is intented for an in between page if needed
@app.route("/takephoto")
def takephotobutton():
...
# Route is intended as seperate page to stop recording to support seperate in between page
...
if __name__ == '__main__':
    ...
    print("VKW Videobooth App Version " + version + " on port 5006 intended VKW weekend, option to record video and take a photo")
